...
Shader "AmplifyShaderPack/Community/Dissolve Burn"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputCustomLightingCustom o )
		{
			...
			o.Emission = tex2DNode114.rgb + 1E-5;
		}
...
Node;AmplifyShaderEditor.OneMinusNode;71;-1760,320;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StickyNoteNode;154;-992,432;Inherit;False;313;136;;;0,0,0,1;Here we take the X component of our UV which is the left position in our burn ramp texture. We take the dissolve amount value to pan into color black shutting off emission;0;0
...
WireConnection;0;15;114;0
ASEEND*/
//CHKSM=E1FD78826BEB6EFD4517CF8D3AC83FF84401319C