...
Shader "Planets"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			o.Emission = ( ( 1.0 - fresnelNode2 ) * tex2D( _MainTex, uv_MainTex ) ).rgb;
			o.Alpha = 1;
		}
...
Node;AmplifyShaderEditor.OneMinusNode;4;-416,176;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=5AE1FF4BF752FEA5B0A7688A597816A91C02368F