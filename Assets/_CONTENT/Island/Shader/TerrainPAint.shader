...
#define _screenprojection_arr BanterTerrainPaint
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			half4 lerpResult37 = lerp( ( lerpResult24 * half4( decodeLightMap35 , 0.0 ) ) , float4( 0,0,0,0 ) , _terrainlight_Instance);
			...
			half3 hsvTorgb80 = HSVToRGB( half3(temp_output_81_0,( hsvTorgb79.y + 0.8 ),hsvTorgb79.z) );
			...
			half4 lerpResult77 = lerp( ( ( ( lerpResult24 * ( tex2D( _Video, uv2_Video ) * _screenprojection_Instance ) ) * i.vertexColor ) + clampResult68 ) , half4( hsvTorgb80 , 0.0 ) , saturate( tex2DNode73.r ));
			half smoothstepResult78 = smoothstep( 0.0 , 0.05 , tex2DNode73.r);
			half smoothstepResult93 = smoothstep( 0.05 , 0.06 , tex2DNode73.r);
			half3 hsvTorgb98 = HSVToRGB( half3(temp_output_81_0,0.8,0.8) );
			half4 temp_output_95_0 = ( lerpResult77 + half4( ( ( smoothstepResult78 - smoothstepResult93 ) * hsvTorgb98 ) , 0.0 ) );
			o.Emission = ( lerpResult37 + temp_output_95_0 ).rgb;
			o.Alpha = 1;
		}
...
Node;AmplifyShaderEditor.RangedFloatNode;31;410.9495,-284.5104;Inherit;False;InstancedProperty;_screenprojection;screenprojection;9;0;Create;True;0;0;0;True;0;False;0.25;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;27;398.1687,-896.7855;Inherit;True;Property;_Video;Video;8;0;Create;True;0;0;0;False;0;False;-1;None;9fcb8cf15a79d7949b513ea805fabad0;True;2;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.VertexColorNode;21;1100.405,-67.6243;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;73;900.316,357.7705;Inherit;True;Property;_PaintMask;PaintMask;10;0;Create;True;0;0;0;False;0;False;-1;None;e350a7062e8f6aa4e80c8c9209580e9d;True;1;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;82;-172.1716,273.5643;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.08;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;57;1601.239,-513.072;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ClampOpNode;68;1804.894,-159.8681;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;1,1,1,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;81;14.65103,195.6045;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SmoothstepOpNode;78;1447.449,285.3929;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0.05;False;1;FLOAT;0
Node;AmplifyShaderEditor.SmoothstepOpNode;93;1449.149,409.2304;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0.05;False;2;FLOAT;0.06;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;84;7.605839,79.96988;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.8;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;34;77.92691,389.6468;Inherit;True;Sample Lightmap;2;;1;6976f0f966a01684ca0a6dde441141c2;6,209,0,195,0,196,0,238,0,191,0,249,0;2;71;FLOAT3;0,0,0;False;169;FLOAT3;0,0,0;False;2;COLOR;0;COLOR;178
...
Node;AmplifyShaderEditor.SimpleAddOpNode;67;1981.015,-77.64213;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SaturateNode;104;1576.774,144.4331;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;94;1716.247,370.4156;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.HSVToRGBNode;98;1804.876,562.8547;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0.8;False;2;FLOAT;0.8;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.DecodeLightmapHlpNode;35;443.8301,339.4555;Inherit;True;2;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;96;2156.213,338.4968;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;38;2062.665,-198.1528;Inherit;False;InstancedProperty;_terrainlight;terrainlight;11;0;Create;True;0;0;0;True;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;37;2370.757,-351.2314;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.OneMinusNode;100;929.418,830.1198;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.NegateNode;107;935.7089,552.7654;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;108;966.7089,645.7654;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0.5;False;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;106;2225.948,585.3624;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;101;2125.841,724.2752;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SaturateNode;102;2566.178,67.35699;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;110;2545.872,-190.033;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
WireConnection;110;0;37;0
WireConnection;110;1;95;0
WireConnection;0;2;110;0
ASEEND*/
//CHKSM=EE930F972B2EAC39304EF24691856D2624F18003