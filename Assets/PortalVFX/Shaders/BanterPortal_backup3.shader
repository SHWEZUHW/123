...
#define _Spawn_arr BanterPortalC
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				#endif
				float2 texCoord122 = i.ase_texcoord1.xy * _Tiling + _Offset;
				float3 worldToObj50 = mul( unity_WorldToObject, float4( _WorldSpaceCameraPos, 1 ) ).xyz;
				float temp_output_52_0 = ( sqrt( length( worldToObj50 ) ) * 0.8 );
				float temp_output_57_0 = (-3.0 + (temp_output_52_0 - 0.0) * (-1.0 - -3.0) / (1.0 - 0.0));
				...
				float2 texCoord2 = i.ase_texcoord1.zw * float2( 1,1 ) + appendResult211;
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;109;673.6699,-659.2163;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;133;145.4492,172.7437;Inherit;False;Property;_Color;Color;2;0;Create;True;0;0;0;False;0;False;0.6591351,0.1367925,1,0;1,0.4470588,0.9666867,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SmoothstepOpNode;22;-12.43628,529.1738;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0.4;False;2;FLOAT;0.45;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;210;-2439.52,-343.0081;Inherit;False;Property;_Offset;Offset;5;1;[PerRendererData];Create;True;0;0;0;False;0;False;0.15,0;0.15,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
ASEEND*/
//CHKSM=B8DDD38EF539EFE57A67339B0142572EF00E734E